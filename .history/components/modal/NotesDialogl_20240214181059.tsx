                        ...
                        <div>
                            ...
                            <div className="mt-3 flex">
                                ...
                                <div className="relative mt-1 inline-block">
                                    <input type="checkbox" onClick={handleClick} className="h-6 w-12 cursor-pointer appearance-none rounded-full border border-gray-300 bg-white checked:border-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2" />
