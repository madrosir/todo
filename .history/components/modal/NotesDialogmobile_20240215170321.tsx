    ...
    return (
        ...
        >
            <DialogTrigger asChild ref={closeRef}  >
                ...
                >
                    <svg
                        className="fill-none stroke-slate-500 duration-300 group-hover:fill-slate-800 group-active:fill-teal-600 group-active:stroke-teal-200 group-active:duration-0"
                        viewBox="0 0 24 24"
                        height="50px"
                        width="50px"
