                        ...
                        <div>
                            ...
                            <div className="mt-3 flex">
                                ...
                                <div className="relative mt-1">
                                    ...
                                    <span className="pointer-events-none absolute left-1 top-1 h-4 w-4 rounded-full bg-gray-400 transition-all duration-200 peer-checked:left-7 peer-checked:bg-gray-900"> </span>
                                </div>
                            </div>
