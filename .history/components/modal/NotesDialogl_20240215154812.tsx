    ...
    return (
        ...
        >
            <DialogTrigger asChild ref={closeRef}  >
                <Button className="text-md w-full justify-between bg-slate-300 font-semibold shadow-md hover:bg-slate-400 max-md:block" variant="ghost"> Create Notes  <Plus /> </Button>
            </DialogTrigger>
            <DialogContent >
                <DialogHeader>
