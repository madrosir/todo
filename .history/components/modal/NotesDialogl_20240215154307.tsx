...
import { useRef, ElementRef, useState, ReactNode, } from "react";
...
interface NotesDialogProps {
    children: ReactNode; // ReactNode represents any valid JSX content
    // Add other prop types as needed
}

const NotesDialog: React.FC<NotesDialogProps> = ({ children }) => {
