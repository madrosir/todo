                        ...
                        <div>
                            ...
                            <div className="mt-3 flex">
                                ...
                                <div className="relative mt-1 inline-block">
                                    ...
                                    <span className="pointer-events-none left-1 top-1 block h-4 w-4 rounded-full bg-gray-400 transition-all duration-200 peer-checked:left-7 peer-checked:bg-gray-900"> </span>
                                </div>
                            </div>
