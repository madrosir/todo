    ...
    return (
        ...
        >
            <DialogTrigger asChild ref={closeRef} >
                <Button className="text-md w-full justify-between bg-slate-300 font-semibold shadow-md hover:bg-slate-400" variant="ghost"> Create Notes  <Plus /> </Button>
            </DialogTrigger>
            <DialogContent >
                <DialogHeader>
                    ...
                    <form action={onSubmit} className="space-y-4">
                        ...
                        <div>
                            <div className="text-md">
                                <span className="my-3 mr-5 inline-block font-semibold">Expiry date:</span>
                            ...
                            <div className="mt-3 flex">
                                ...
                                <label className="relative inline-flex cursor-pointer items-center">
                                    ...
                                    <div className="peer h-10 w-28 rounded-full bg-blue-300 outline-none duration-100 after:absolute after:left-1 after:top-1 after:flex after:h-12 after:w-12 after:items-center after:justify-center after:rounded-full after:bg-white after:font-bold after:text-sky-800 after:outline-none after:duration-500 after:content-['No'] peer-checked:after:translate-x-14 peer-checked:after:border-white peer-checked:after:content-['Yes'] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-500">
                                    </div>
                                </label>
                            </div>
