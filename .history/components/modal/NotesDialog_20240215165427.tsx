                        ...
                        <div>
                            ...
                            <div className="mt-3 flex">
                                ...
                                <label className="relative z-0 inline-flex cursor-pointer items-center">
                                    <input className="peer sr-only z-0" onClick={handleClick} value="" type="checkbox" />
                                    <div className="w-18 h-18 peer z-0 rounded-full bg-slate-300 outline-none duration-100 after:absolute after:left-1 after:top-1 after:flex after:h-8 after:w-8 after:items-center after:justify-center after:rounded-full after:bg-white after:font-bold after:text-slate-800 after:outline-none after:duration-500 after:content-['No'] peer-checked:after:translate-x-10 peer-checked:after:border-white peer-checked:after:content-['Yes'] peer-focus:outline-none">
                                    </div>
                                </label>
                            </div>
