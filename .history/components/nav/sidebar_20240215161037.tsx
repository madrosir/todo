...
const Sidebar = () => {
    ...
    return (
        <div>
            <section className="shadow-light-300 sticky left-0 top-0 mx-auto mr-3 hidden h-full w-[300px] flex-col overflow-y-auto border-r border-slate-300 bg-slate-200 p-6 pt-4 shadow-lg md:block lg:block">
