...
const Sidebar = () => {
    ...
    return (
        <div >
            <section className="   custom-scrollbar sticky left-0 top-0  h-screen flex-col   border-r p-6 pt-4 shadow-light-300 dark:shadow-none lg:block w-[300px] mr-3 overflow-y-auto mx-auto hidden ">
