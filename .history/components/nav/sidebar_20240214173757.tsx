...
import { Star, CalendarOff } from "lucide-react";
import NotesDialog from "./NotesDialog"; // Import your components
import Search from "./Search"; // Import your components
import NotesSheet from "./NotesSheet"; // Import your components
...
const Sidebar = () => {
    ...
    function handleImportant() {
        ...
        setSelectedButton("important"); // Set the selected button
    }
