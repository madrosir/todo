            ...
            <section className="custom-scrollbar shadow-light-300 sticky left-0 top-0 mx-auto mr-3 hidden h-screen w-[300px] flex-col overflow-y-auto border-r border-slate-300 bg-slate-200 p-6 pt-4 shadow-lg lg:block">
                ...
                <div className="w-full" role="button">
                    <button
                        ...
                        className={`mt-5 flex h-12 w-full items-center rounded-2xl text-start shadow-sm hover:bg-slate-300 ${selectedButton === "true" ? "bg-black" : ""
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`$ mt-5 flex h-12 w-full items-center rounded-2xl text-start shadow-sm hover:bg-slate-300`}
                    >
